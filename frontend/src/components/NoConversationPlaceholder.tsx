...
const NoConversationPlaceholder = () => {
  ...
  return (
    <div className="flex flex-col items-center justify-center h-full texxt-center p-6">
      ...
      <p className="text-slate-400 max-w-md">Choose a contact from the sidebar to start chhatting or continue a previous conversation.</p>
    </div>
  )
}
