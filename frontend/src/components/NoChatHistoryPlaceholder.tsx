...
const NoChatHistoryPlaceholder = ({ name }: Props) => {
    ...
    return (
        <div className="flex flex-col items-center justify-center h-full text-center p-6">
            <div className="size-16 bg-gradient-to-br from-cyan-500/20 to-cyan-400/10 rounded-full
        flex items-center justify-center mb-5">
            ...
            <div className="flex flex-col space-y-3 max-w-md mb-5">
                <p className="text-slate-400 text-sm">
                    this is the beginning of your conversation. Send a message ot start chatting!
                </p>
